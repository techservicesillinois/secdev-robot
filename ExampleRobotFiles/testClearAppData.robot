...
Go to Apps and Notifications ${var}
    Click Text    Apps & notifications
    Sleep  5s
    ${recent}    Run Keyword And Return Status  Page Should Contain Text    ${var}
    # Click App IF it is in the Recent List, ELSE go to Chosen App logic
    Run Keyword If      ${recent} == True     Click Text   ${var}     ELSE    Go to Chosen App 
